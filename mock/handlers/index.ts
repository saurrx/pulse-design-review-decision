...
export const handlers: HttpHandler[] = [...authHandlers, ...ideaHandlers, ...dashboardHandlers, ...patentHandlers, ...actionHandlers, ...clientHandlers, ...inviteHandlers, ...fileHandlers, ...legacyHandlers(), egressHandler()];
