...
export const PRODUCT_CARD_CLASS =
  "rounded-md border border-[var(--pulse-line)] bg-[var(--pulse-surface)] p-6 font-sans [box-shadow:var(--pulse-shadow-card)]";
...
export const PRODUCT_SEGMENTED_CONTROL_CLASS =
  "inline-flex shrink-0 items-center rounded-sm border border-[var(--pulse-line)] bg-[var(--pulse-surface-subtle)] p-1";

export const PRODUCT_SEGMENTED_ITEM_CLASS =
  "inline-flex h-8 items-center justify-center gap-1.5 rounded-xs px-3 text-[13px] font-medium transition-[background-color,color,box-shadow] duration-150";
