      ...
      <div className="flex min-h-full flex-col bg-[#f7f7f5]">
        <div className="flex flex-1 items-start justify-center p-6">
          <section className="w-full max-w-2xl rounded-2xl border border-neutral-200 bg-white px-8 py-12 text-center shadow-sm">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-[#fff6df] text-[#9c6b00]">
              <MessageSquareText className="h-5 w-5" />
            </div>
            <div className="mt-5 inline-flex rounded-full border border-neutral-200 bg-neutral-50 px-3 py-1 text-xs font-semibold text-neutral-600">
              Coming soon
            </div>
