...
const meta = { title: "Legacy reference/Screens/Draft workspace", component: IdeaDraftPage, parameters: { pulse: { path: "/ideas/:id/draft" } } } satisfies Meta<typeof IdeaDraftPage>;
export default meta;
