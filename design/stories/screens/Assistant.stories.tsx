...
const meta = { title: "Screens/Assistant", component: AssistantPage, parameters: { pulse: { scenario: "photon-admin/firm", persona: "PHOTON_ADMIN", route: "/assistant" } } } satisfies Meta<typeof AssistantPage>;
export default meta;
